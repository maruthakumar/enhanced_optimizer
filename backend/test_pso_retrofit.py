#!/usr/bin/env python3
"""
Test PSO Algorithm Retrofit for Parquet/Arrow/cuDF Support
"""
...
def test_pso_cpu_mode():
    """Test PSO with CPU mode (numpy)"""
    print("Testing PSO Algorithm Retrofit - CPU Mode")
    print("=" * 60)
    ...
    # Initialize PSO algorithm in CPU mode
    pso = ParticleSwarmOptimization(use_gpu=False)
    print("Initialized PSO in CPU mode")
    
    # Run optimization
    portfolio_size = 10
    print(f"\nRunning PSO optimization for portfolio size {portfolio_size}...")
...
def test_pso_parameters():
    ...
    print("\n" + "=" * 60)
    print("Testing PSO with different parameters")
    print("=" * 60)
    ...
    print("\n✅ All PSO parameter tests passed!")
...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("PSO Retrofit Test Summary:")
