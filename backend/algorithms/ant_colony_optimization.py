...
class AntColonyOptimization:
    ...
    def __init__(self):
        ...
        self.algorithm_description = "Ant Colony Optimization"
        ...
        self.logger.info("✅ Ant Colony Optimization initialized")
    ...
    def optimize(self, daily_matrix: np.ndarray, portfolio_size: int, 
        ...
        try:
            self.logger.info(f"🐜 Starting Ant Colony Optimization")
            
            num_strategies = daily_matrix.shape[1]
            num_ants = kwargs.get('num_ants', 15)
            ...
            self.logger.error(f"❌ ACO failed: {str(e)}")
